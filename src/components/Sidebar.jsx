        ...
        return (
            <div className="w-12 bg-gradient-to-b from-indigo-50 to-white border-r border-indigo-100 flex flex-col items-center shadow-lg">
                ...
                <div className="flex flex-col gap-4 mt-6">
                    <div className="w-2 h-2 rounded-full bg-indigo-600 shadow-lg shadow-indigo-200" title="Fields"></div>
                    <div className="w-1.5 h-1.5 rounded-full bg-gray-300" title="Elements"></div>
                    <div className="w-1.5 h-1.5 rounded-full bg-gray-300" title="Templates"></div>
                    <div className="w-1.5 h-1.5 rounded-full bg-gray-300" title="Rules"></div>
                </div>
            </div>
        );
    }
        ...
        <div className="w-96 border-r border-gray-200 bg-gradient-to-b from-white to-gray-50 flex flex-col h-screen shadow-xl">
            ...
            <div className="px-6 py-5 border-b border-indigo-100 flex justify-between items-center flex-shrink-0 bg-gradient-to-r from-indigo-600 via-indigo-600 to-indigo-700 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 relative z-10">
                    ...
                    <h2 className="text-lg font-bold text-white">Edunext Template Builder</h2>
                </div>
                <button
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {Object.entries(elementTypes).map(([type, config]) => (
                                        ...
                                        >
                                            ...
                                            <config.icon size={24} className="text-gray-700 group-hover:text-indigo-600 transition-colors relative z-10" />
                        ...
                        {!selectedElement && (
                            <div className="border-t border-gray-200 bg-gradient-to-b from-white to-gray-50 p-8">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-gray-800 font-semibold mb-1">No element selected</p>
