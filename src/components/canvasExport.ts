import { addTemplate } from '../templateStore';
...
export const downloadHTML = (elements: any[], filename = "template.html") => {
...
export const saveTemplate = (templateName: any, elements: any) => {
