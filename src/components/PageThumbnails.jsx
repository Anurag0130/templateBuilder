        ...
        <div className="w-32 bg-gray-100 border-r overflow-y-auto p-2">
            {pages.map((page, index) => (
                <div
                    ...
                    className={`mb-2 cursor-pointer rounded border-2 ${index === currentIndex
            ...
            <button
                onClick={onAddPage}
                className="w-full aspect-[794/1123] border-2 border-dashed 
        border-gray-300 hover:border-indigo-400 rounded 
